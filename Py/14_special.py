####################################################################################
# Scope definition can be made anywhere in C++

####################################################################################
# Operator overloading is kinda the same when you define the dunder methods (see example)
# https://www.youtube.com/watch?v=mS9755gF66w

####################################################################################
# pointers and addresses in python and C++
...
# How memory works in python: http://foobarnbaz.com/2012/07/08/understanding-python-variables/

###################################################################################
# Passing functions into functions is kinda the same in Python and C++
